exports.config = {
    ...
    // Specify Test Files
    // ==================
    // Define which tests features should run. The pattern is relative to the directory
    // from which `wdio` was called. Notice that, if you are calling `wdio` from an
    // NPM script (see https://docs.npmjs.com/cli/run-script) then the current working
    // directory is where your package.json resides, so `wdio` will be called from there.
    //
    specs: [
        'tests/features/featureFiles/**/*.feature'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    // order to group specific features to a specific capability.
    //
    ...
    // services: [],//
    // Framework you want to run your features with.
    ...
    cucumberOpts: {
        require: ['tests/features/step_definitions/**/*.js'], // <string[]> (file/dir) require files before executing features
    ...
    // the tests.
    // after: function (result, capabilities, features) {
    // },
    //
    // Gets executed right after terminating the webdriver session.
    // afterSession: function (config, capabilities, features) {
    // },
    //
